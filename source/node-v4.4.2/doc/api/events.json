      ...
      "classes": [
        {
          ...
          "methods": [
            ...
            },
            {
              ...
              "type": "method",
              "name": "once",
              "desc": "<p>Adds a <strong>one time</strong> <code>listener</code> function for the event named <code>eventName</code>. This\nlistener is invoked only the next time <code>eventName</code> is triggered, after which\nit is removed.\n\n</p>\n<pre><code class=\"js\">server.once(&#39;connection&#39;, (stream) =&gt; {\n  console.log(&#39;Ah, we have our first user!&#39;);\n});</code></pre>\n<p>Returns a reference to the <code>EventEmitter</code> so calls can be chained.\n\n</p>\n",
              "signatures": [
                {
                  "params": [
                    {
